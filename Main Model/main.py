...
class main_window(QMainWindow):
    ...
    def connectUI(self):
        ...
        self.CopIntelligentMovement.released.connect(self.enableSmartCops)
    ...
    def updateLegitimacy(self):
        ...
        self.L = newL/100
        self.legitLabel.setText("Legitimacy = {}".format(newL))
        for a in self.agents:
            a.L = self.L
    def enableSmartCops(self):
        """This function enables intelligent cop movement"""
        # get the button state
        state = self.CopIntelligentMovement.isChecked()
        for c in self.cops:
            c.intelligentMovement = state
